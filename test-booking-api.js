...
async function testBookingAPI() {
  try {
    ...
    if (loginResponse.data && loginResponse.data.success && loginResponse.data.user) {
      ...
      const bookingData = {
        userId: user.id,  // Set to logged in user id
        ...
        depositAmount: '200.00', // Using string format for decimal values
        balanceDue: '800.00'     // Using string format for decimal values
      };
