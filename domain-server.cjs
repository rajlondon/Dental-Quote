/**
 * Extremely simple domain server for MyDentalFly
 * CommonJS module for maximum compatibility
 */
...
// Basic HTML landing page that loads on all paths
...
const server = http.createServer((req, res) => {
  ...
  if (req.url === '/api/health') {
    ...
    res.end(JSON.stringify({
      ...
      message: 'MyDentalFly static landing page is operational'
    }));
    return;
  }
  
  // For all other requests, serve the landing page
