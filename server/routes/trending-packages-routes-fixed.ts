...
// Sort helper for promotion levels and featured order
const sortByPromotionAndOrder = (a: TrendingPackage, b: TrendingPackage) => {
...
router.get('/api/trending-packages', (req, res) => {
  // Collect all active and approved packages from all clinics
  ...
  allPackages.sort(sortByPromotionAndOrder);
...
router.get('/api/trending-packages/homepage', (req, res) => {
  ...
  homepagePackages.sort(sortByPromotionAndOrder);
