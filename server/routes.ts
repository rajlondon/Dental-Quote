...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Register dental chart routes for patient portal
  app.use('/api/dental-chart', isAuthenticated, setupDentalChartRoutes());
  ...
  app.get('/api/patient/profile', isAuthenticated, async (req, res, next) => {
    try {
      ...
      // Use basic user data with referral system ready
