...
`;
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system", 
          content: "You are an expert React and TypeScript developer specialized in debugging complex web applications."
        },
        {
          role: "user",
          content: prompt
    ...
    await fs.promises.writeFile(analysisFilePath, analysis, 'utf8');
