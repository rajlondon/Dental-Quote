...
function Router() {
  ...
  return (
    <>
      ...
      {/* Basic Quote Demo - standalone with no dependencies */}
      ...
      <Route path="/quote/treatments" component={StandaloneQuotePage} />
      <Route path="/quote/patient-info" component={StandaloneQuotePage} />
      <Route path="/quote/summary" component={StandaloneQuotePage} />
      ...
      {/* Final Quote Builder - Industrial-grade solution with isolated state management */}
      <Route path="/final-quote" component={() => {
        const FinalQuoteBuilder = React.lazy(() => import("./pages/FinalQuoteBuilder"));
        return (
      ...
      {/* Zustand Quote Builder - Global state management with localStorage persistence */}
      <Route path="/zustand-quote" component={() => {
        const ZustandQuoteBuilder = React.lazy(() => import("./pages/ZustandQuoteBuilder"));
        return (
          <React.Suspense fallback={<div className="flex justify-center items-center min-h-screen">Loading Zustand quote builder...</div>}>
            <ZustandQuoteBuilder />
          </React.Suspense>
        );
      }} />
      ...
      {/* Final Quote Builder - Most reliable implementation */}
      <Route path="/simple-quote" component={() => {
        const SimpleQuotePage = React.lazy(() => import("./pages/SimpleQuotePage"));
        return (
          <React.Suspense fallback={<div className="flex justify-center items-center min-h-screen">Loading final quote builder...</div>}>
            <SimpleQuotePage />
          </React.Suspense>
      ...
      {/* Enhanced Quote Builder - Primary quote builder route for production */}
      <Route path="/quote" component={() => {
      ...
      <Route path="/documented-quote" component={() => {
        ...
        return (
          <React.Suspense fallback={<div className="flex justify-center items-center min-h-screen">Loading documented quote builder...</div>}>
            <DocumentedQuotePage />
          </React.Suspense>
        );
      }} />
      ...
      <Route path="/quote" component={() => {
        ...
        // If clinic staff, don't redirect, show a message
        if (isClinicStaff) {
      ...
      {/* Package Test Page - Standalone package and treatment selection */}
      <Route path="/package-test" component={React.lazy(() => import("@/pages/PackageTestPage"))} />
