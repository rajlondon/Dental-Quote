                  ...
                  <div className="w-full mt-2">
                    <div className="bg-blue-50 py-3 px-4 rounded-md">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2">
                        ...
                        <div className="flex justify-between">
                          <span className="text-gray-700">Average at quality clinic:</span>
                      ...
                      <div className="border rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                        ...
                        <div className="p-4">
                          ...
                          <div className="mt-4 text-sm">
                            ...
                            <p><span className="font-semibold">Average at quality clinic:</span> <span className="text-gray-500 line-through">£7,500</span></p>
                      ...
                      <div className="border rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                        ...
                        <div className="p-4">
                          ...
                          <div className="mt-4 text-sm">
                            ...
                            <p><span className="font-semibold">Average at quality clinic:</span> <span className="text-gray-500 line-through">£5,200</span></p>
                      ...
                      <div className="border rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                        ...
                        <div className="p-4">
                          ...
                          <div className="mt-4 text-sm">
                            ...
                            <p><span className="font-semibold">Average at quality clinic:</span> <span className="text-gray-500 line-through">£19,800</span></p>
