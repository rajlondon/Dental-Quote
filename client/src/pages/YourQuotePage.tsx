        ...
        <div className="container mx-auto px-4">
          ...
          <Card className="mb-8" data-clinic-selection>
            <CardHeader>
              ...
              <CardDescription>
                Select from our verified partner clinics in Istanbul. All prices include consultation and treatment planning.
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="space-y-6">
                {clinics.map((clinic) => (
                  <div key={clinic.id} className="border rounded-lg p-6 hover:shadow-md transition-shadow">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <div className="text-right">
                            <div className="mb-4">
                              <p className="text-2xl font-bold text-blue-600">£{clinic.priceGBP}</p>
                            ...
                            <Button 
                              ...
                              onClick={() => {
                                // Save clinic selection and redirect to patient portal
                                localStorage.setItem('selectedClinicId', clinic.id);
                                localStorage.setItem('selectedClinicName', clinic.name);
                                localStorage.setItem('selectedClinicPrice', clinic.priceGBP.toString());

                                // Save treatment data if any
                                if (treatmentItems.length > 0) {
                                  localStorage.setItem('selectedTreatments', JSON.stringify(treatmentItems));
                                }
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                          <div>
                            <h4 className="font-medium text-sm text-gray-700 mb-2">Clinic Features</h4>
                            <div className="space-y-1">
                              {clinic.features.slice(0, 3).map((feature, index) => (
                        ...
                        <div className="flex items-center text-sm text-gray-700 font-medium">
                          ...
                          <span>Concierge by {clinic.conciergeType === 'mydentalfly' ? 'MyDentalFly' : 'clinic'}</span>
                        </div>
                      </div>
                    </div>
                  </div>
