...
// Simple symbols for icons that work consistently in PDFs
const TICK_ICON = "✓";          // Checkmark for list items
const HOTEL_ICON = "◼";         // Hotel icon (square symbol)
const TRANSFER_ICON = "◇";      // Transfer/taxi icon (diamond symbol)
const TRANSLATOR_ICON = "○";    // Translator/specialist icon (circle symbol)
