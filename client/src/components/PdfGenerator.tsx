...
// Path to icons for amenities
const TICK_ICON = "✓";          // Checkmark for list items
const HOTEL_ICON = '[Hotel]';    // Hotel icon 
const TRANSFER_ICON = '[Car]';   // Transfer/taxi icon 
const TRANSLATOR_ICON = '[Chat]'; // Translator/specialist icon
