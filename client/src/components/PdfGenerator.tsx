...
// Symbols for amenities - using standard text for PDF compatibility
const HOTEL_ICON = '[Hotel]';      // Hotel icon
const TRANSFER_ICON = '[Transfer]'; // Transfer/taxi icon 
const TRANSLATOR_ICON = '[Translator]'; // Translator/specialist icon
