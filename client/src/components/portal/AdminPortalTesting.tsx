...
import { ArrowRight, CheckCircle2, Clock, TestTube, AlertCircle, ShieldAlert } from 'lucide-react';
import { getPortalFeatures, getWorkflowSteps, getSecurityFeatures } from './PortalTestingGuide';

interface AdminPortalTestingProps {
  setActiveSection: (section: string) => void;
}

const AdminPortalTesting: React.FC<AdminPortalTestingProps> = ({ setActiveSection }) => {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold flex items-center">
            ...
            {t('testing.admin_portal.title', 'Admin Portal Testing Mode')}
          </h2>
          <p className="text-gray-500 mt-1">
            {t('testing.admin_portal.description', 'Test and validate admin portal functionality')}
          </p>
        </div>
      ...
      <Alert className="bg-purple-50 border-purple-200">
        ...
        <AlertDescription className="text-purple-600">
          {t('testing.test_mode_description', 'Use this testing interface to validate admin portal functionality. This mode allows you to test features without affecting production data.')}
        </AlertDescription>
      </Alert>
      ...
      <Tabs defaultValue="features">
        ...
        <TabsContent value="features" className="space-y-4">
          <h3 className="text-lg font-semibold mb-2">
            {t('testing.feature_list.title', 'Admin Portal Features')}
          </h3>
              ...
              <Card key={index}>
                ...
                <CardFooter className="pt-0 pb-3">
                  <Button 
                    variant="ghost" 
                    size="sm" 
                    className="text-purple-600 p-0 h-auto hover:text-purple-800 hover:bg-transparent"
                    onClick={() => {
        ...
        <TabsContent value="workflow" className="space-y-4">
          <h3 className="text-lg font-semibold mb-2">
            {t('testing.workflow.title', 'Admin User Workflow')}
          </h3>
        ...
        <TabsContent value="security" className="space-y-4">
          <h3 className="text-lg font-semibold mb-2">
            {t('testing.security.title', 'Admin Portal Security')}
          </h3>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {t('testing.test_credentials.description', 'Use these credentials for testing admin portal access.')}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="font-mono bg-gray-100 p-2 rounded mt-1">admin@mydentalfly.com</p>
                </div>
                <div>
              ...
              <div className="mt-4 text-sm text-gray-500">
                <p>
                  <strong>{t('testing.test_credentials.note', 'Note')}:</strong> {t('testing.test_credentials.note_text', 'These credentials are for testing purposes only and provide access to a demo admin account. Admin accounts have full platform privileges.')}
                </p>
              </div>
            </CardContent>
            <CardFooter>
