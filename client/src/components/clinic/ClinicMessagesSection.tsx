    ...
    <div className="space-y-6">
      <Card className="h-[calc(100vh-13rem)]">
        <CardHeader className="pb-4">
          ...
          <CardDescription>
            Communicate with your patients directly through the platform
          </CardDescription>
        </CardHeader>
                    ...
                    {loading ? (
                      ...
                      <div className="flex items-center justify-center p-8">
                        <div className="flex flex-col items-center text-center">
                          ...
                          <p className="text-sm text-muted-foreground">
                            You don't have any message threads yet. Create a test message to see how it works.
                          </p>
                        </div>
                      </div>
                    ) : (
                    ...
                    {loading ? (
                      ...
                      <div className="flex items-center justify-center h-64 text-center p-4">
                        <div>
                          ...
                          <h3 className="font-medium mb-1">No Active Conversations</h3>
                          <p className="text-sm text-muted-foreground">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>When enabled, messages are automatically translated between English and Turkish.</p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  </div>
                  ...
                  {loadingMessages ? (
                    ...
                    <div className="flex items-center justify-center h-full text-center">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Start the conversation by sending a message to this patient.
                        </p>
                      </div>
                    </div>
                  ) : (
