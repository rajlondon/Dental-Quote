...
export const LazyQuoteFlow: React.FC<LazyQuoteFlowProps> = ({ 
  ...
  return (
    <Suspense fallback={<LoadingFallback />}>
      ...
      {step === 'confirmation' && <QuoteConfirmation quoteId={quoteId} onComplete={onComplete} />}
      {step === 'email' && <QuoteConfirmationEmail quoteId={quoteId} recipientEmail={recipientEmail} />}
    </Suspense>
  );
};