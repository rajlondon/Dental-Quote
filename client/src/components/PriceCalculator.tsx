...
const getTooltipForTerm = (term: string): string => {
  const descriptions: Record<string, string> = {
    Zirconium:
      "High-strength ceramic material known for durability and aesthetics",
    "E-Max":
      "All-ceramic material combining excellent aesthetics with good strength",
    "Metal-Ceramic":
      "Traditional crown with metal base and porcelain exterior for strength and appearance",
    ...
    Gingivectomy:
      "Surgical removal of gum tissue to treat gum disease or reshape gums",
    Frenectomy: "Procedure to remove or modify connective tissue in mouth",
    "Sinus Lift":
      "Bone augmentation procedure to add bone to upper jaw for implant placement",
...
const InfoIcon = ({
  ...
  const safeContent =
    tooltipContent || "More information will be provided upon request.";
...
const DentalTermTooltip = ({ treatment }: { treatment: string }) => {
  ...
  if (!tooltipContent || tooltipContent.length < 10) {
    tooltipContent =
      "Information about " + treatment + ". Contact us for more details.";
  }
...
export default function PriceCalculator({ 
  ...
  const [uploadedXrayFiles, setUploadedXrayFiles] = useState<
    Array<{
      filename: string;
      originalname: string;
      path: string;
  ...
  const onSubmit = async (data: FormValues) => {
      ...
      try {
        ...
        if (response.data.success) {
          ...
          toast({
            ...
            description:
              "Your dental information has been saved with your quote",
          });
        }
      } catch (error) {
    ...
    if (data.xrayFiles && data.xrayFiles.length > 0) {
      ...
      try {
        ...
        toast({
          title: "Upload Failed",
          description:
            "There was a problem uploading your X-ray files. You can proceed with your quote and send X-rays later.",
          variant: "destructive",
        });
      }
    }
    ...
    try {
      ...
      axios
        .post("/api/notify-quote-calculation", notificationData)
        .then((response) => {
          console.log("Quote calculation notification sent:", response.data);
        })
        .catch((error) => {
          console.error(
            "Failed to send quote calculation notification:",
            error,
          );
  ...
  const downloadQuotePDF = () => {
    try {
      ...
      if (quote && quote.items.length > 0) {
        ...
        const allClinics = [
          {
            ...
            priceGBP: Math.round(quote.totalGBP * 0.8),
          ...
          },
          {
            ...
            priceGBP: Math.round(quote.totalGBP * 0.9),
          ...
          {
            name: "Vera Smile",
            priceGBP: Math.round(quote.totalGBP * 1.0),
        ...
        const clinicPriceFactors = [0.8, 0.9, 1.0]; // Price factors for each clinic (Affordable, Mid-Tier, Premium)
        const selectedFactor = clinicPriceFactors[selectedClinic];
        const selectedClinicTotalGBP = Math.round(
          quote.totalGBP * selectedFactor,
        );
        const selectedClinicTotalUSD = Math.round(
          quote.totalUSD * selectedFactor,
        );
        ...
        const dentalChartData = localStorage.getItem("dentalChartData");
        const parsedDentalChart = dentalChartData
          ? JSON.parse(dentalChartData)
          : null;
        ...
        quoteData = {
          ...
          xrayFiles:
            uploadedXrayFiles.length > 0 ? uploadedXrayFiles : undefined,
      ...
      // Or we're in the dialog view
        ...
        quoteData = {
          ...
          clinics: [
            {
              name: "Istanbul Dental Care",
              priceGBP: Math.round(htmlQuoteData.totalGBP * 0.8),
              extras: "Simple procedures & budget-focused travel",
              guarantee: "3 Years",
              location: "Affordable",
              rating: "⭐⭐⭐⭐",
            ...
            {
              name: "DentGroup Istanbul",
              priceGBP: Math.round(htmlQuoteData.totalGBP * 0.9),
              extras: "Balanced budget + comfort with aftercare support",
              guarantee: "5 Years",
              location: "Mid-Tier",
              rating: "⭐⭐⭐⭐½",
            ...
            {
              name: "Vera Smile",
              priceGBP: Math.round(htmlQuoteData.totalGBP * 1.0),
              extras: "VIP clients, faster results, luxury environment",
              guarantee: "10 Years",
              location: "Premium",
              rating: "⭐⭐⭐⭐⭐",
        ...
        toast({
          title: "Error",
          description:
            "No quote data available. Please generate a quote first.",
          variant: "destructive",
        });
        return;
      }
      ...
      try {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            toast({
              title: "Success",
              description:
                "Your quote PDF should open in a new tab. If not, please check your popup blocker settings.",
              variant: "default",
            });
          }, 1000);
        }, 200);
        ...
        toast({
          ...
          description:
            "PDF download failed. Please check your email for a copy, or try again.",
          variant: "destructive",
        });
      }
    } catch (error) {
      ...
      toast({
        ...
        description: (
          <div>
            <p>
              PDF download failed. Please try the alternative options below:
            </p>
            <a
  ...
  const openHtmlQuote = () => {
    try {
      ...
      setHtmlQuoteData({
        ...
        hasXrays: hasXrays,
        xrayCount:
          hasXrays && quoteData.xrayFiles ? quoteData.xrayFiles.length : 0,
        // Include new fields
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-neutral-600 max-w-3xl mx-auto">
              Calculate the exact cost of your dental treatment in Istanbul and
              receive a detailed quote that you can download instantly.
            </p>
          </div>
                      ...
                      <div className="space-y-4">
                        <div className="bg-primary/5 p-4 rounded-lg">
                          ...
                          <div className="bg-white rounded-lg p-4 mb-4 border border-neutral-200">
                            ...
                            <div className="space-y-3 text-sm">
                              <ol className="list-decimal pl-5 space-y-1 text-neutral-700">
                                <li>
                                  Select each dental treatment you need from the
                                  dropdown menu
                                </li>
                                <li>
                                  Enter the quantity (number of teeth) for each
                                  treatment
                                </li>
                                <li>
                                  Add multiple treatments if needed using the
                                ...
                                <li>
                                  Use the interactive dental chart below to mark
                                  specific teeth conditions or treatments
                                </li>
                              </ol>
                              ...
                              <div className="bg-primary/5 p-3 rounded mt-2">
                                ...
                                <ul className="list-disc pl-5 space-y-1 text-neutral-600 text-xs">
                                  <li>
                                    ...
                                    can only be determined after examining
                                    dental X-rays/CT scans
                                  </li>
                                  <li>
                                    If you have recent X-rays or CT scans,
                                    please send these after receiving your quote
                                  </li>
                                  <li>
                                    For dental implants, please specify quantity
                                    and brand (if you have a preference)
                                  </li>
                                  <li>
                                    For crowns, veneers, and other treatments,
                                    please indicate quantity needed
                                  </li>
                                  <li>
                                    Our dental team will help finalize your
                                    treatment plan during your consultation
                                  </li>
                                </ul>
                                <p className="mt-2 text-xs text-neutral-600">
                                  To ensure your quote is as accurate as
                                  possible, you can upload recent X-rays or CT
                                  scans. Our partner clinics will review them
                                  and confirm with you if any adjustments are
                                  needed. Your quote will be updated before you
                                  travel, so you always know what to expect.
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                            ...
                            <p className="text-sm text-blue-700 mb-4">
                              Click on teeth to indicate conditions (chipped,
                              painful, missing) or desired treatments (implants,
                              crowns, veneers).
                            </p>
                            <DentalChart
                          ...
                          {form.watch("treatments").map((_, index) => (
                            <div
                              key={index}
                              className="flex flex-col sm:flex-row gap-3 items-start bg-white p-3 rounded-lg mb-3 border border-neutral-200 shadow-sm"
                            >
                                        ...
                                        <TooltipProvider>
                                          <Tooltip>
                                            ...
                                            <TooltipContent className="max-w-xs">
                                              <p className="text-xs">
                                                Select your required dental
                                                treatment from the dropdown. We
                                                offer a wide range of procedures
                                                including implants, veneers,
                                                crowns, and more. Each has
                                                  ...
                                                  <div className="p-4 space-y-3">
                                                    ...
                                                    <div className="mt-3 grid grid-cols-2 gap-2 text-xs bg-primary/5 p-2 rounded">
                                                      <div>
                                                        ...
                                                        <p className="text-neutral-600">
                                                          £
                                                          {treatmentDetails.priceGBP.toLocaleString()}{" "}
                                                          / $
                                                          {treatmentDetails.priceUSD.toLocaleString()}
                                                        </p>
                                                      </div>
                                    ...
                                    <FormItem>
                                      <div className="flex flex-wrap items-center">
                                        ...
                                        <div className="relative inline-block">
                                          ...
                                          >
                                            <p className="text-xs">
                                              Enter the number of teeth or areas
                                              that need this treatment. For
                                              example, if you need 4 dental
                                              implants, enter '4' here.
                                            </p>
                                          </div>
                                        </div>
                                      </div>
                              ...
                              {form.watch("treatments").length > 1 && (
                                ...
                                >
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-5 w-5 mr-1 sm:mr-0"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                  >
                        ...
                        <div className="mt-6 space-y-5">
                            ...
                            render={({ field }) => (
                              <FormItem className="space-y-2">
                                <FormLabel className="text-primary font-semibold">
                                  Who would you like to guide your journey?
                                </FormLabel>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                  ...
                                  >
                                    <div className="flex items-start mb-2">
                                      <input
                                        ...
                                        onChange={() =>
                                          field.onChange("concierge")
                                        }
                                        className="mt-1 mr-3"
                                      />
                                      <div>
                                        <h4 className="font-semibold">
                                          MyDentalFly.com (Full Concierge)
                                        </h4>
                                        <p className="text-sm text-neutral-600 mt-1">
                                          We'll handle everything from clinic
                                          booking to accommodation and
                                          transportation
                                        </p>
                                      </div>
                                    </div>
                                  ...
                                  >
                                    <div className="flex items-start mb-2">
                                      ...
                                      <div>
                                        <h4 className="font-semibold">
                                          The Clinic (We hand you over)
                                        </h4>
                                        <p className="text-sm text-neutral-600 mt-1">
                                          We'll connect you with the clinic, and
                                          they'll provide their own concierge
                                          service
                                        </p>
                                      </div>
                                    </div>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem className="space-y-2">
                                <FormLabel className="text-primary font-semibold">
                                  Would you like a £150 consultation in London?
                                </FormLabel>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                  <div
                                    className={`p-4 border-2 rounded-lg cursor-pointer transition-all ${
                                  ...
                                  >
                                    <div className="flex items-start mb-2">
                                      ...
                                      <div>
                                        <h4 className="font-semibold">
                                          Yes, I'd like a London consultation
                                        </h4>
                                        <p className="text-sm text-neutral-600 mt-1">
                                          Includes X-rays and a detailed
                                  ...
                                  >
                                    <div className="flex items-start mb-2">
                                      ...
                                      <div>
                                        <h4 className="font-semibold">
                                          No, I'll have my consultation in
                                          Istanbul
                                        </h4>
                                        <p className="text-sm text-neutral-600 mt-1">
                                          Consultation and X-rays are provided
                                          free at the clinic in Istanbul
                                        </p>
                                      </div>
                                    </div>
                                  </div>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem className="space-y-2">
                                <FormLabel className="text-primary font-semibold">
                                  Are you replacing existing crowns or veneers?
                                </FormLabel>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <Select
                                  onValueChange={field.onChange}
                                  defaultValue={field.value || "no_preference"}
                                >
                                  <FormControl>
                                    <SelectTrigger className="bg-white">
                                  ...
                                  <SelectContent>
                                    ...
                                    <SelectItem value="premium_eu">
                                      Premium European brands (German/Swiss)
                                    </SelectItem>
                                    <SelectItem value="premium_usa">
                                      Premium USA brands
                                    </SelectItem>
                                    <SelectItem value="premium_korea">
                                      Premium South Korean brands
                                    </SelectItem>
                                    <SelectItem value="guide_me">
                                      I'm unsure — please guide me
                                    </SelectItem>
                                  </SelectContent>
                                </Select>
                                <FormDescription className="text-xs text-neutral-500">
                                  <span className="block mb-1">
                                    All clinics we work with use high-quality,
                                    time-tested materials from globally
                                    recognized brands.
                                  </span>
                                  <div className="pl-5 space-y-1 my-2">
                                    ...
                                    <div className="flex items-baseline">
                                      ...
                                      <span>
                                        ...
                                        : Osstem, Dentium (excellent quality,
                                        cost-effective)
                                      </span>
                                    </div>
                                  </div>
                                  <span className="block mt-1">
                                    Specific brand requests can be discussed
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormDescription className="text-xs text-neutral-500">
                                  This helps us suggest the most suitable
                                  options for your financial comfort
                                </FormDescription>
                              </FormItem>
                            )}
                          />
                        ...
                        <div className="mt-6 border rounded-lg p-4 bg-white border-primary/20">
                            ...
                            <TooltipProvider>
                              <Tooltip>
                                <TooltipTrigger asChild>
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-5 w-5 ml-2 text-neutral-400"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                  >
                                ...
                                <TooltipContent>
                                  <p className="max-w-xs text-xs">
                                    Uploading your X-rays or CT scans will help
                                    our dental team provide a more accurate
                          ...
                          <p className="text-sm text-neutral-600 mb-3">
                            For more accurate quotes, upload your recent dental
                            X-rays or CT scans (optional)
                          </p>
                              ...
                              <FormItem>
                                ...
                                >
                                  <div className="border-2 border-dashed border-primary/30 rounded-lg p-8 text-center hover:bg-primary/5 transition-colors">
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      className="h-10 w-10 mx-auto text-primary/60"
                                      fill="none"
                                      viewBox="0 0 24 24"
                                      stroke="currentColor"
                                    >
                    ...
                    <div ref={quoteResultRef} className="space-y-4">
                            ...
                            {quote.items.map((item, idx) => (
                              ...
                              >
                                ...
                                <td className="px-4 py-3 text-right">
                                  £{item.subtotalGBP.toLocaleString()}
                                </td>
                              </tr>
                            ))}
                          </tbody>
                            ...
                            <tr>
                              ...
                              <td className="px-4 py-3 text-right text-primary">
                                ...
                                {(() => {
                                  ...
                                  const clinicPriceFactors = [0.85, 0.8, 0.9]; // Price factors for each clinic
                                  const selectedFactor =
                                    clinicPriceFactors[selectedClinic];
                                  return Math.round(
                                    quote.totalGBP * selectedFactor,
                                  ).toLocaleString();
                                })()}
                            ...
                            <tr>
                              ...
                              <td className="px-4 py-3 text-right text-primary">
                                ...
                                {(() => {
                                  ...
                                  const clinicPriceFactors = [0.8, 0.9, 1.0]; // Price factors for each clinic
                                  const selectedFactor =
                                    clinicPriceFactors[selectedClinic];
                                  return Math.round(
                                    quote.totalUSD * selectedFactor,
                      ...
                      <div className="p-4 bg-primary/5 rounded-lg mb-6">
                        ...
                        <p className="text-sm mb-3">
                          Each quote includes vetted options from affordable,
                          mid-tier, and premium clinics in Istanbul. Choose what
                          suits your comfort and budget best:
                        </p>
                          ...
                          {[
                            {
                              name: "Istanbul Dental Care",
                              type: "🏷️ Affordable",
                              price: Math.round(quote.totalGBP * 0.8),
                              extra:
                                "Simple procedures & budget-focused travel",
                              guarantee: "3 Years",
                              rating: "⭐⭐⭐⭐",
                            },
                            {
                              name: "DentGroup Istanbul",
                              type: "💼 Mid-Tier",
                              price: Math.round(quote.totalGBP * 0.9),
                              extra:
                                "Balanced budget + comfort with aftercare support",
                              guarantee: "5 Years",
                              rating: "⭐⭐⭐⭐½",
                            },
                            {
                              name: "Vera Smile",
                              type: "💎 Premium",
                              price: Math.round(quote.totalGBP * 1.0),
                              extra:
                                "VIP clients, faster results, luxury environment",
                              guarantee: "10 Years",
                              rating: "⭐⭐⭐⭐⭐",
                            },
                          ].map((clinic, idx) => {
                      ...
                      <div className="p-4 bg-primary/5 rounded-lg">
                        <h4 className="font-semibold text-primary mb-2">
                          Cost Comparison: UK vs Istanbul
                        </h4>
                        <p className="text-sm mb-3">
                          See how much you can save compared to UK costs:
                        </p>
                        <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-2 sm:space-y-0 pt-2">
                          {(() => {
                            ...
                            const selectedClinicData =
                              istanbulClinics[selectedClinic];
                            ...
                            return comparisonData.map((clinic, idx) => {
                              ...
                              return (
                                <div
                                  key={idx}
                                  className={`w-full sm:flex-1 p-4 rounded-lg ${isIstanbulClinic ? "border-2 border-primary bg-primary/5 text-gray-800" : "bg-white"}`}
                                >
                                  {isIstanbulClinic && (
                                    <div className="mb-4">
                        ...
                        {(() => {
                          ...
                          const selectedClinicPrice = [
                            Math.round(quote.totalGBP * 0.8), // Hantipaciek Clinic (Affordable)
                            Math.round(quote.totalGBP * 0.9), // DentGroup Istanbul (Mid-Tier)
                            Math.round(quote.totalGBP * 1.0), // DentSpa Istanbul (Premium)
                          ][selectedClinic];

                          // Calculate Estimated UK Cost
                          const estimatedUKCost =
                            (Math.round(quote.totalGBP * 3.2) +
                              Math.round(quote.totalGBP * 2.8)) /
                            2;

                          // Calculate savings
                          const savings = estimatedUKCost - selectedClinicPrice;
                          const savingsPercent = Math.round(
                            (savings / estimatedUKCost) * 100,
                          );
                          ...
                          return (
                            <>
                              ...
                              <div className="text-xs text-center mt-2">
                                * Pricing data sourced from Gemini deep research
                                of average UK clinic rates
                              </div>
                            </>
                          );
                        })()}
                        ...
                        {(() => {
                          ...
                          return (
                            <JSPDFGenerator
                              ...
                              hasXrays={hasXrays}
                              xrayCount={
                                form.getValues("xrayFiles")?.length || 0
                              }
                              selectedClinicIndex={selectedClinic}
                            />
                          );
                      ...
                      <div className="mt-4 bg-amber-50 border border-amber-200 rounded-lg p-3 text-sm text-amber-800">
                        <p>
                          ...
                          This quote is based on the information you've provided
                          and the selections you've chosen. After an X-ray
                          (which we can help arrange), your final treatment plan
                          and price will be confirmed — usually within ±10% of
                          this quote.
                        </p>
                      </div>
...
export function PriceCalculator() {
  ...
  const totalGBP = quoteContext?.totalGBP || 0;
  const totalUSD = quoteContext?.totalUSD || 0;
  const discountAmount = quoteContext?.discountAmount || 0;
  const finalTotalGBP = quoteContext?.finalTotalGBP || 0;
  const finalTotalUSD = quoteContext?.finalTotalUSD || 0;
  ...
  const ukTotalGBP = treatments.reduce((sum, treatment) => sum + (treatment.ukPriceGBP || 0) * treatment.quantity, 0);
  const savingsGBP = ukTotalGBP - finalTotalGBP;
  const savingsPercentage = ukTotalGBP > 0 ? Math.round((savingsGBP / ukTotalGBP) * 100) : 0;

  if (!quoteContext || treatments.length === 0) {
    return (
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mb-3 text-sm">
              Select your treatments and fill in your details to generate your personalized quote
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">Special package pricing applied</p>
            </div>
          </div>
        </div>
      )}
          ...
          <div key={treatment.id} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
            <div className="flex-1">
              ...
              <div className="text-sm text-gray-500">
                Quantity: {treatment.quantity} • {treatment.guarantee || 'N/A'} warranty
              </div>
            </div>
            <div className="text-right">
              ...
              <div className="text-sm text-gray-500">
                ${treatment.subtotalUSD?.toLocaleString()}
              </div>
            </div>
          </div>
        ))}
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            ...
            <span className="font-medium">£{totalGBP.toLocaleString()} / ${totalUSD.toLocaleString()}</span>
          </div>
          ...
          <div className="flex justify-between text-lg font-semibold">
            <span>Total</span>
            <span className="text-primary">£{finalTotalGBP.toLocaleString()}</span>
          </div>
          
          <div className="flex justify-between text-sm text-gray-600">
            <span>USD equivalent</span>
            <span>${finalTotalUSD.toLocaleString()}</span>
          </div>
        </div>
      </div>
                        ...
                        <div className="border-t border-gray-200 pt-6">
                              ...
                              <div className="flex items-center mb-2">
                                ...
                                <TooltipProvider delayDuration={100}>
                                  <Tooltip>
                                    ...
                                    >
                                      Clinics use trusted implant brands for
                                      durability & patient safety. If you have a
                                      brand preference, let us know — we'll
                                      match you where possible.
                                    </TooltipContent>
                                  </Tooltip>
                                </TooltipProvider>
                              </div>
                              <p className="text-xs text-gray-600">
                                Clinic Preferred Brands
                              </p>
                            </div>
                              ...
                              <div className="flex items-center mb-2">
                                ...
                                <TooltipProvider delayDuration={100}>
                                  <Tooltip>
                                    ...
                                    >
                                      Veneers come in various materials — chosen
                                      for beauty and long-lasting quality. Your
                                      clinic will guide you on the best choice
                                      for your smile.
                                    </TooltipContent>
                                  </Tooltip>
                                </TooltipProvider>
                              ...
                              <div className="flex items-center mb-2">
                                ...
                                <TooltipProvider delayDuration={100}>
                                  <Tooltip>
                                    ...
                                    >
                                      Crowns protect your teeth — clinics use
                                      brands known for strength & fit. Cosmetic
                                      preferences can be discussed during your
                                      consultation.
                                    </TooltipContent>
                                  </Tooltip>
                                </TooltipProvider>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div className="rounded-lg border border-gray-200 overflow-hidden">
                              ...
                              <div className="p-3">
                                ...
                                <div className="mb-1">
                                  ...
                                  <div className="text-[11px] text-gray-600">
                                    • Full Mouth Rehabilitation: 8 Implants + 12
                                    Zirconia Crowns
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="p-3">
                                  <div className="flex justify-between items-center mb-1">
                                    <span className="text-xs text-gray-600">
                                      Average round-trip from London to Istanbul
                                    </span>
                              ...
                              <div className="rounded-lg border border-gray-200 overflow-hidden">
                                <div className="bg-primary/10 py-2 px-3 border-b border-gray-200">
                                  <h5 className="font-medium text-sm text-primary">
                                    Average savings compared to UK costs
                                  </h5>
                                </div>
                                ...
                                <div className="p-3">
                                  <div className="flex justify-between items-center mb-1">
                                    <span className="text-xs text-gray-600">
                                      Based on UK private dental pricing surveys
                                    </span>
                                  ...
                                  <div className="text-[11px] text-gray-500 mt-2">
                                    * Average savings compared to private UK
                                    dental prices
                                  </div>
                                </div>
                              </div>
                          ...
                          <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 text-center mb-4">
                            <p className="text-xs text-blue-700">
                              Remember — your quote today gives you a clear
                              guide on treatment pricing. Your final treatment
                              plan will be tailored after your X-rays &
                              consultation with our partner clinics however you
                              will have the price list for your preferred clinic
                              prior to the consultation to refer to.
                            </p>
                          </div>
      ...
      <Dialog open={showHtmlQuote} onOpenChange={setShowHtmlQuote}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Quote Number: {htmlQuoteData?.quoteNumber} | Date:{" "}
              {htmlQuoteData?.date}
            </DialogDescription>
          </DialogHeader>
            ...
            <div id="quote-content" className="space-y-6 py-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <p className="font-medium">
                      {htmlQuoteData.patientName || "Not provided"}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-neutral-500">Email</p>
                    <p className="font-medium">
                      {htmlQuoteData.patientEmail || "Not provided"}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-neutral-500">Phone</p>
                    <p className="font-medium">
                      {htmlQuoteData.patientPhone || "Not provided"}
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <table className="w-full border-collapse">
                    ...
                    <tbody>
                      ...
                      <tr className="font-bold bg-primary/5">
                        ...
                        <td className="px-4 py-3 text-right">
                          £{htmlQuoteData.totalGBP.toLocaleString()}
                        </td>
                        <td className="px-4 py-3 text-right">
                          ${htmlQuoteData.totalUSD.toLocaleString()}
                        </td>
              ...
              <div className="bg-amber-50 p-4 rounded-lg border border-amber-200 mb-4">
                <h3 className="text-lg font-semibold text-amber-800 mb-2">
                  Important Note About Quote Accuracy
                </h3>
                <p className="text-amber-700">
                  This quote is based on the information you've provided and the
                  treatments you've selected. After an X-ray review (which we
                  can help arrange), your final treatment plan and price will be
                  confirmed — usually within ±10% of this quote.
                </p>
              </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div>
                    <p className="text-sm text-neutral-500">
                      Equivalent UK Cost Range:
                    </p>
                    <p className="text-xl font-bold">
                      £{(htmlQuoteData.totalGBP * 2.5).toLocaleString()} - £
                      {(htmlQuoteData.totalGBP * 3).toLocaleString()}
                    </p>
                  </div>
                  <div className="mt-2 md:mt-0 bg-green-50 p-2 rounded-md border border-green-200">
                    <p className="text-sm text-green-600">
                      Your Savings with MyDentalFly.com:
                    </p>
                    <p className="text-xl font-bold text-green-700">
                      £{(htmlQuoteData.totalGBP * 1.75).toLocaleString()} (65%
                      saving)
                    </p>
                  </div>
                </div>
              ...
              <div>
                <h3 className="text-lg font-semibold text-primary mb-2">
                  Istanbul Clinic Comparison
                </h3>
                <p className="text-sm mb-3">
                  We work with these partner clinics in Istanbul - compare their
                  offers below:
                </p>
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse">
                      ...
                      <tr className="bg-primary/5 font-bold">
                        ...
                        >
                          <div className="text-sm text-center text-primary">
                            All prices include consultation, treatment, and
                            aftercare. The clinic with the best value for your
                            specific needs will be recommended during your
                            consultation.
                          </div>
                        </td>
                      </tr>
              ...
              <div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse">
                    ...
                    <tbody>
                      <tr>
                        <td className="px-4 py-3 border-b border-neutral-200">
                          London clinic average price*
                        </td>
                        <td className="px-4 py-3 border-b border-neutral-200 text-right">
                          £
                          {Math.round(
                            htmlQuoteData.totalGBP * 3.2,
                          ).toLocaleString()}
                        </td>
                        <td className="px-4 py-3 border-b border-neutral-200">
                      ...
                      <tr className="bg-neutral-50">
                        <td className="px-4 py-3 border-b border-neutral-200">
                          Manchester clinic average price*
                        </td>
                        <td className="px-4 py-3 border-b border-neutral-200 text-right">
                          £
                          {Math.round(
                            htmlQuoteData.totalGBP * 2.8,
                          ).toLocaleString()}
                        </td>
                        <td className="px-4 py-3 border-b border-neutral-200">
                          Price without travel costs
                      ...
                      <tr className="font-bold bg-green-50">
                        ...
                        <td className="px-4 py-3 border-b border-neutral-200 text-right text-green-700">
                          £
                          {Math.round(
                            (Math.round(htmlQuoteData.totalGBP * 3.2) +
                              Math.round(htmlQuoteData.totalGBP * 2.8)) /
                              2 -
                              htmlQuoteData.totalGBP,
                          ).toLocaleString()}
                        </td>
                ...
                <div className="text-xs mt-2 text-neutral-500 text-right">
                  UK pricing data sourced from Gemini AI deep research of
              ...
              <div>
                <h3 className="text-lg font-semibold text-primary mb-2">
                  What's Included With Your Treatment
                </h3>
              ...
              <div className="bg-primary/5 p-4 rounded-lg">
                ...
                <ol className="space-y-2 pl-5 list-decimal">
                  <li className="pl-2">
                    Contact MyDentalFly.com to confirm your treatment plan
                  </li>
                  <li className="pl-2">
                    Book your flight to Istanbul for your chosen dates
                  </li>
                  <li className="pl-2">
                    We will arrange airport transfer and accommodation options
                  </li>
                </ol>
                ...
                <div className="mt-4 bg-white p-4 rounded-lg border border-neutral-200">
                  ...
                  <p>
                    Email us at <strong>info@mydentalfly.com</strong> or message
                    us on WhatsApp: <strong>+447572445856</strong>
                  </p>
                  <p className="text-sm text-neutral-500 mt-2">
                    We'll handle your travel, treatment, and care — all you do
